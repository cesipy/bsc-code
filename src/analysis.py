...
def _create_similarity_heatmaps(
    ...
    axes[0].set_title(f'Cross-Modal {title_prefix}', fontsize=18, pad=20);
    axes[1].set_title(f'Text {title_prefix}', fontsize=18, pad=20)
    axes[2].set_title(f'Vision {title_prefix}', fontsize=18, pad=20)
    ...
    axes[0].set_xlabel('Vision Layer', fontsize=16);axes[0].set_ylabel('Text Layer',     fontsize=16)
    axes[1].set_xlabel('Text Layer',   fontsize=16);  axes[1].set_ylabel('Text Layer',   fontsize=16)
    axes[2].set_xlabel('Vision Layer', fontsize=16);axes[2].set_ylabel('Vision Layer',   fontsize=16)

    # Set ticks
    for ax in axes:
        ax.set_xticks(range(num_layers))
        ax.set_yticks(range(num_layers))
        ax.set_xticklabels(range(num_layers), fontsize=12)
        ax.set_yticklabels(range(num_layers), fontsize=12)
