...
def main():
    ...
    pretrained_paths = [
        "res/checkpoints/pretrains/20251010-234252_pretrained_early_fusion.pt",
        "res/checkpoints/pretrains/20251011-234349_pretrained_middle_fusion.pt",
        "res/checkpoints/pretrains/20251013-010227_pretrained_late_fusion.pt",
        "res/checkpoints/pretrains/20251014-034432_pretrained_asymmetric_fusion.pt",
    ]
